  ...
  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow overflow-hidden">
    <div className="flex items-center justify-between p-6 border-b border-gray-100 dark:border-gray-700">
      <div className="flex items-center">
        ...
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Tendances mensuelles</h2>
      </div>
    ...
    <div className="p-1 sm:p-2 md:p-4 overflow-x-auto">
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2 md:gap-4 min-w-[600px]">
        {stats.monthlyTrends.map((monthData, index) => (
          <div 
            key={index} 
            className={`relative rounded-lg bg-gray-50 dark:bg-gray-700 p-4 transition-all hover:bg-blue-50 dark:hover:bg-blue-900/30 hover:shadow ${
              monthData.value > 0 ? 'border-l-4 border-blue-500' : 'border-l-4 border-gray-200 dark:border-gray-600'
            }`}
          >
            <div className="font-medium text-gray-700 dark:text-gray-200 mb-3 pb-2 border-b border-gray-200 dark:border-gray-600">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className={`font-medium text-sm ${monthData.contacts > 0 ? 'text-gray-800 dark:text-gray-200' : 'text-gray-400 dark:text-gray-500'}`}>
                  {monthData.contacts}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <span className={`font-medium text-sm ${monthData.deals > 0 ? 'text-gray-800 dark:text-gray-200' : 'text-gray-400 dark:text-gray-500'}`}>
                  {monthData.deals}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center pt-1 border-t border-gray-200 dark:border-gray-600">
                ...
                <span className={`font-semibold text-sm ${monthData.value > 0 ? 'text-blue-600 dark:text-blue-400' : 'text-gray-400 dark:text-gray-500'}`}>
