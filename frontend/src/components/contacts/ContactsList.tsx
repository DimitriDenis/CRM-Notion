...
return (
  <ul role="list" className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
    {contacts.map((contact, index) => (
      <li key={contact.id} className="col-span-1 rounded-lg bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow hover:shadow-md dark:shadow-gray-900/30 dark:hover:shadow-gray-900/50 transition-all relative flex flex-col">
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 flex divide-x divide-gray-200 dark:divide-gray-600">
