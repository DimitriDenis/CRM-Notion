  ...
  return (
    <ul role="list" className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {contacts.map((contact) => (
        <li key={contact.id} className="col-span-1 divide-y divide-gray-200 rounded-lg bg-white shadow">
...
function ContactMenu({ contact, onDelete }: { contact: Contact; onDelete: (id: string) => void }) {
  return (
    <div className="absolute top-0 right-0 p-2">
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className="flex items-center rounded-full bg-white text-gray-400 hover:text-gray-600 focus:outline-none">
